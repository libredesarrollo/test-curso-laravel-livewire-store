...
window.toast = (toast_me__WEBPACK_IMPORTED_MODULE_1___default()); //toast('My message')

var options = {
  position: 'bottom'
};
Livewire.on('itemDelete', function () {
  toast_me__WEBPACK_IMPORTED_MODULE_1___default()("El item ha sido eliminado :(", options);
});
Livewire.on('itemAdd', function (post) {
  toast_me__WEBPACK_IMPORTED_MODULE_1___default()("El item ha sido agregado", options);
});
Livewire.on('itemChange', function (post) {
  toast_me__WEBPACK_IMPORTED_MODULE_1___default()("El item ha cambiado " + post.title, options);
});
